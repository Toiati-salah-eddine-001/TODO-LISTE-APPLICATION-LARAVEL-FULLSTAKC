            ...
            <header class="bg-white shadow-sm z-10">
                <div class="flex items-center justify-between p-4">
                    ...
                    <div class="flex items-center">
                        <div class="relative">
                            <input type="text" placeholder="Search..." class="border rounded-md py-2 px-3 pl-8 focus:outline-none focus:ring-2 focus:ring-blue-500">
                    ...
                    <div class="flex items-center">
                        <div class="relative">
                            <button class="flex items-center text-gray-700 focus:outline-none">
                                <img src="https://randomuser.me/api/portraits/men/1.jpg" alt="Admin" class="h-8 w-8 rounded-full mr-2">
            ...
            <main class="flex-1 overflow-y-auto bg-gray-100 p-4">
                ...
                <div class="bg-white rounded-lg shadow-sm mb-6">
                    <div class="p-4 border-b flex justify-between items-center">
                        ...
                        <div>
                            <button id="refresh-btn" class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-md text-sm">
                                <i class="fas fa-sync-alt mr-1"></i> Refresh
                            </button>
                            <button id="add-demo-data" class="bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded-md text-sm ml-2">
                    ...
                    <div class="p-4 bg-gray-50 border-b">
                        <div class="flex flex-wrap items-center gap-4">
                            <div class="flex items-center">
                                ...
                                <select id="status-filter" class="border rounded-md px-3 py-1 focus:outline-none focus:ring-2 focus:ring-blue-500">
                            ...
                            <div class="flex items-center">
                                <label for="user-filter" class="mr-2 text-sm text-gray-600">User:</label>
                                <select id="user-filter" class="border rounded-md px-3 py-1 focus:outline-none focus:ring-2 focus:ring-blue-500">
                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody id="task-table-body" class="bg-white divide-y divide-gray-200">
                                ...
                                <tr>
                                    <td colspan="5" class="px-6 py-4 text-center text-gray-500">No tasks found. Add some demo data to get started.</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                    ...
                    <div class="px-4 py-3 bg-gray-50 border-t flex items-center justify-between">
                        <div class="text-sm text-gray-500">
                            Showing <span id="showing-count">0</span> of <span id="total-count">0</span> tasks
                        </div>
